...
QT_MOC_LITERAL(7, 82, 21), // "reloadTickersFromFile"
QT_MOC_LITERAL(8, 104, 16), // "increaseFontSize"
QT_MOC_LITERAL(9, 121, 16), // "decreaseFontSize"
QT_MOC_LITERAL(10, 138, 12), // "openSettings"
QT_MOC_LITERAL(11, 151, 9), // "openAbout"
QT_MOC_LITERAL(12, 161, 10), // "endProgram"
QT_MOC_LITERAL(13, 172, 13) // "loadStockData"

    },
    "MainWindow\0customContextMenuRequested\0"
    "\0pos\0exitProg\0launchSigMach\0showContextMenu\0"
    "reloadTickersFromFile\0increaseFontSize\0"
    "decreaseFontSize\0openSettings\0openAbout\0"
    "endProgram\0loadStockData"
};
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow::customContextMenuRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow::exitProg)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWindow::launchSigMach)) {
                *result = 2;
                return;
            }
        }
